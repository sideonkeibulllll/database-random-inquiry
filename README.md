...
API Token 是一个简单的字符串，建议使用强密码生成器生成。例如：

```
API_TOKEN=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyIiwiaWF0IjoxNzA0MTQ2MDEwLCJleHAiOjE3MzU2ODIwMDB9.SIGNATURE
```
